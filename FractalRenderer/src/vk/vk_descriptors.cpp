...
//> growpool_3
 VkDescriptorSet DescriptorAllocatorGrowable::allocate(VkDevice device, VkDescriptorSetLayout layout, void* pNext)
 {
     ...
     if (device == VK_NULL_HANDLE) {
         fmt::print("ERROR: Device is null in allocate()\n");
         std::abort();
     }
     if (layout == VK_NULL_HANDLE) {
         fmt::print("ERROR: Layout is null in allocate() - descriptor layout wasn't created!\n");
         std::abort();
     }
     ...
     if (poolToUse == VK_NULL_HANDLE) {
         fmt::print("ERROR: Pool is null in allocate()\n");
         std::abort();
     }
     ...
     if (result == VK_ERROR_OUT_OF_POOL_MEMORY || result == VK_ERROR_FRAGMENTED_POOL) {
         ...
         fmt::print("ERROR: vkAllocateDescriptorSets failed with error code: {}\n", (int)result);
         std::abort();
     }
